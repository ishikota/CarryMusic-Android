...
public class LocalPlayback implements Playback, AudioManager.OnAudioFocusChangeListener,
    ...
    @Override
    public void play(MusicProviderSource item) {
        mPlayOnFocusGain = true;
        tryToGetAudioFocus();
        registerAudioNoisyReceiver();
        String mediaId = item.getVideoId();
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED && !mediaHasChanged && mMediaPlayer != null) {
            ...
            MusicProviderSource source = Realm.getDefaultInstance().where(MusicProviderSource.class)
                    .equalTo("videoId", item.getVideoId()).findFirst();
            ...
            try {
                ...
                mMediaPlayer.setDataSource(source.getVideoPath());
